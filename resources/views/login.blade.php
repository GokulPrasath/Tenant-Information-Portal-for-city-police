...
@section('content')
 ...
 <form id="cpolice" class="form-horizontal col-lg-offset-2 col-md-offset-2 col-sm-offset-2 col-lg-8 col-md-8 col-sm-8 " action="{{ url('/register') }}">
    ...
    <div class="col-lg-10 col-md-10 col-sm-10 ">
      ...
      <div class="col-lg-8 col-md-8 col-sm-8 ">
          <input type="text" class="form-control" name="bgid" id="bgid" placeholder="Enter Bagde Id" required="required">
      </div>
    </div>
	<br/>
    <br/>
